...
hdr_info_file_rep1="/home_path/10X/del_1a_2_13_21/rep1_dna_parallel.summTable.concat.umi_collapsed.id.out.txt"
hdr_info_df_rep1=read.table(hdr_info_file_rep1, header=T)

#modify id
hdr_info_df_rep1[,1]=paste("rep1_", hdr_info_df_rep1[,1] , "-1", sep="")

hdr_info_file_rep2="/home_path/10X/del_1a_2_13_21/rep2_dna_parallel.summTable.concat.umi_collapsed.id.out.txt"
