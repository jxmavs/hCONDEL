...
do
    roadmapID=${array[0]}
    stat_out_file=${outDir}/${out_header}_${roadmapID}_${modType}_cutOff_${cutOffVal}_stat_out.txt
    rm -f ${stat_out_file}
	rm -f ${outDir}/${out_header}_*_${roadmapID}_${modType}_cutOff_${cutOffVal}_stat_out.txt 
	echo -e "${outDir}/${out_header}_${roadmapID}_${modType}_cutOff_${cutOffVal}_stat_out.txt"
