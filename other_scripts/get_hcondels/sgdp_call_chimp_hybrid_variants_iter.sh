...
sgdp_bam_dir=$1
sgdp_vcf_dir=$2
chimp_human_hybrid_out_fasta_name=$3
...
do
    file_id=${array[1]}
    echo -e "bash call_sgdp_SV_variants.sh ${sgdp_bam_dir} ${sgdp_vcf_dir} ${chimp_human_hybrid_out_fasta_name} ${file_id} ${genome_file_id}" >> ${temp_dir}/all_runs_call_SV_${genome_file_id}.txt
...
qsub ${temp_dir}/submit_all_call_SV_${genome_file_id}.sh ${temp_dir}/all_runs_call_SV_${genome_file_id}.txt
